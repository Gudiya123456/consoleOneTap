...
export default function ForgotPassword() {
    ...
    const validate = () => {
        ...
        if (isUserExist) {
            ...
            if (!params.email) {
                errors = { ...errors, email: 'phone is required!' };
            }
        }
        console.log(errors)
        setErros(errors);
                        ...
                        <div className="relative hidden w-full items-center justify-center bg-primary-light p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-28 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                            ...
                            <div className="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                                ...
                                <div className="mt-24 hidden w-full max-w-[430px] lg:block">
                                    <img src={''} alt="Cover Image" className="w-full" />
                                </div>
                            </div>
                        </div>
                       {
                        isResetPassword? <ResetPassword email={params.email}  />:(
                            ...
                            <div className="w-full max-w-[440px] lg:mt-16">
                                <div className="mb-7">
                                    <h1 className="mb-3 text-2xl font-bold !leading-snug dark:text-white">Login</h1>
                                ...
                                <div className="space-y-5">
                                    <div>
                                        ...
                                        <div className="relative text-white-dark">
                                            <input value={params.email} name='email' disabled={isUserExist} onChange={(e) => changeValue(e)} id="Email" type="email" placeholder="Enter phone no    " className="form-input pl-10 placeholder:text-white-dark" />
