...
const Payment = () => {
  ...
  const validate = (gateWay) => {
    ...
    if (gateWay.environment == "")
      errors = { ...errors, environment: "environment is required" };
  ...
  return (
    <div>
      <div className="space-y-8 px-6 py-6 pt-5">
                        ...
                        <div className="">
                          <div className=" flex gap-2 text-[13px] flex-wrap ">
                            ...
                            <div>
                              ...
                              />
                              <div className="text-danger font-black ">
                                {gateWay == "razorpay" && errors.key
                                  ? errors.key
                                  : ""}
                              </div>
                            </div>
                          ...
                          <div className=" flex gap-2 text-[13px] flex-wrap  mt-2">
                            <div>
                              ...
                              <div>
                                ...
                                />
                                <div className="text-danger font-black ">
                                  {gateWay == "razorpay" && errors.secret
                                    ? errors.secret
                                    : ""}
                                </div>
                              </div>
                            ...
                            <div className="">
                              ...
                              <select
                                ...
                                className="bg-[#FFFFFF]  text-[#B5B5B5] dark:bg-[#202125] border dark:border-[#515151] border-[#D6D6D6] appearance-none  h-[26px] w-[240px] text-sm     pl-3 rounded-full py-[2px] pr-6     flex items-center "
                              >
                              ...
                              <div className="">
                                <label className="inline-flex">
                                  <input
                                    ...
                                    defaultChecked={
                                      razorPay.is_enabled == 1 ? true : false
                                    }
                                    value={1}
                                    onClick={(e) =>
                                      setRazorPay({
                                ...
                                <label className="inline-flex px-5">
                                  <input
                                    ...
                                    name="status"
                                    defaultChecked={
                                      razorPay.is_enabled == 0 ? true : false
                                    }
                                    value={0}
                                    onClick={(e) =>
                                      setRazorPay({
                        ...
                        <div className=" flex gap-2 text-[13px] flex-wrap ">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setPhonePe({ ...phonePe, key: e.target.value })
                              }
                            />
                            <div className="text-danger font-black ">
                              {gateWay == "phonePe" && errors.key
                                ? errors.key
                                : ""}
                            </div>
                          </div>
                        ...
                        <div className=" flex gap-2 text-[13px] flex-wrap  mt-2">
                          ...
                          <div className="">
                            ...
                            <select
                              name="duration"
                              value={
                                phonePe?.environment ? phonePe.environment : ""
                              }
                              onChange={(e) =>
                                setPhonePe({
                                  ...phonePe,
                            ...
                            <div className="">
                              <label className="inline-flex">
                                <input
                                  ...
                                  className="form-radio text-success peer"
                                  defaultChecked={
                                    phonePe.is_enabled == 1 ? true : false
                                  }
                                  value={1}
                                  onClick={(e) =>
                                    setPhonePe({ ...phonePe, is_enabled: 1 })
                                  }
                                />
                                <span
                                  style={{ color: "#32e01d" }}
                              ...
                              <label className="inline-flex px-5">
                                <input
                                  ...
                                  name="status"
                                  defaultChecked={
                                    phonePe.is_enabled == 0 ? true : false
                                  }
                                  value={0}
                                  onClick={(e) =>
                                    setPhonePe({ ...phonePe, is_enabled: 0 })
                                  }
                                  className="form-radio text-danger peer"
                                />
                                <span
                          ...
                          <div>
                            ...
                            <div>
                              <input
                                ...
                                id=""
                                value={
                                  googlePay?.secret ? googlePay.secret : ""
                                }
                                onChange={(e) =>
                                  setGooglePay({
                                    ...googlePay,
                              ...
                              />
                              <div className="text-danger font-black ">
                                {gateWay == "googlePay" && errors.secret
                                  ? errors.secret
                                  : ""}
                              </div>
                            </div>
                            ...
                            <div className="">
                              <label className="inline-flex">
                                <input
                                  ...
                                  className="form-radio text-success peer"
                                  defaultChecked={
                                    googlePay.is_enabled == 1 ? true : false
                                  }
                                  value={1}
                                  onClick={(e) =>
                                    setGooglePay({
                              ...
                              <label className="inline-flex px-5">
                                <input
                                  ...
                                  name="status"
                                  defaultChecked={
                                    googlePay.is_enabled == 0 ? true : false
                                  }
                                  value={0}
                                  onClick={(e) =>
                                    setGooglePay({
                          ...
                          <div>
                            ...
                            <div>
                              <input
                                ...
                                id=""
                                value={
                                  amazonPay?.secret ? amazonPay.secret : ""
                                }
                                onChange={(e) =>
                                  setAmazonPay({
                                    ...amazonPay,
                              ...
                              />
                              <div className="text-danger font-black ">
                                {gateWay == "amazonPay" && errors.secret
                                  ? errors.secret
                                  : ""}
                              </div>
                            </div>
                            ...
                            <div className="">
                              <label className="inline-flex">
                                <input
                                  ...
                                  className="form-radio text-success peer"
                                  defaultChecked={
                                    amazonPay.is_enabled == 1 ? true : false
                                  }
                                  value={1}
                                  onClick={(e) =>
                                    setAmazonPay({
                              ...
                              <label className="inline-flex px-5">
                                <input
                                  ...
                                  name="status"
                                  defaultChecked={
                                    amazonPay.is_enabled == 0 ? true : false
                                  }
                                  value={0}
                                  onClick={(e) =>
                                    setAmazonPay({
                        ...
                        <div className=" flex gap-2 text-[13px] flex-wrap ">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setStripe({ ...stripe, key: e.target.value })
                              }
                            />
                            <div className="text-danger font-black ">
                              {gateWay == "stripe" && errors.key
                                ? errors.key
                                : ""}
                            </div>
                          </div>
                            ...
                            <div className="">
                              <label className="inline-flex">
                                <input
                                  ...
                                  className="form-radio text-success peer"
                                  defaultChecked={
                                    stripe.is_enabled == 1 ? true : false
                                  }
                                  value={1}
                                  onClick={(e) =>
                                    setStripe({ ...stripe, is_enabled: 1 })
                                  }
                                />
                                <span
                                  style={{ color: "#32e01d" }}
                              ...
                              <label className="inline-flex px-5">
                                <input
                                  ...
                                  name="status"
                                  defaultChecked={
                                    stripe.is_enabled == 0 ? true : false
                                  }
                                  value={0}
                                  onClick={(e) =>
                                    setStripe({ ...stripe, is_enabled: 0 })
                                  }
                                  className="form-radio text-danger peer"
                                />
                                <span
                        ...
                        <div className=" flex gap-2 text-[13px] flex-wrap ">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setPayPal({ ...payPal, key: e.target.value })
                              }
                            />
                            <div className="text-danger font-black ">
                              {gateWay == "payPal" && errors.key
                                ? errors.key
                                : ""}
                            </div>
                          </div>
                            ...
                            <div className="">
                              <label className="inline-flex">
                                <input
                                  ...
                                  className="form-radio text-success peer"
                                  defaultChecked={
                                    payPal.is_enabled == 1 ? true : false
                                  }
                                  value={1}
                                  onClick={(e) =>
                                    setPayPal({ ...payPal, is_enabled: 1 })
                                  }
                                />
                                <span
                                  style={{ color: "#32e01d" }}
                              ...
                              <label className="inline-flex px-5">
                                <input
                                  ...
                                  name="status"
                                  defaultChecked={
                                    payPal.is_enabled == 0 ? true : false
                                  }
                                  value={0}
                                  onClick={(e) =>
                                    setPayPal({ ...payPal, is_enabled: 0 })
                                  }
                                  className="form-radio text-danger peer"
                                />
                                <span
