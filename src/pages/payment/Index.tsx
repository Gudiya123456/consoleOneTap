...
//                 method: 'get',
//                 url: window.location.origin + "/api/dashboard/paymentgateway",
//                 headers: {
...
//             if (z) setEnabledGateway(z.payment_gateway_name)
//             const a = paymentGateways.find((p: any) => p.payment_gateway_name == "RazorPay");
//             setRazorPay(a ? a : { payment_gateway_name: "RazorPay", environment: '0', is_enabled: '0' })
//             const b = paymentGateways.find((p: any) => p.payment_gateway_name == "Stripe");
//             setStripe(b ? b : { payment_gateway_name: "Stripe", environment: '0', is_enabled: '0' })
//             const c = paymentGateways.find((p: any) => p.payment_gateway_name == "Paytm");
//             setPaytm(c ? c : { payment_gateway_name: "Paytm", environment: '0', is_enabled: '0' })
//             const d = paymentGateways.find((p: any) => p.payment_gateway_name == "PhonePe");
//             setPhonePe(d ? d : { payment_gateway_name: "PhonePe", environment: '0', is_enabled: '0' })
//             const e = paymentGateways.find((p: any) => p.payment_gateway_name == "PayPal");
//             setPayPal(e ? e : { payment_gateway_name: "PayPal", environment: '0', is_enabled: '0' })
//             const f = paymentGateways.find((p: any) => p.payment_gateway_name == "AmazonPay");
//             setAmazonPay(f ? f : { payment_gateway_name: "AmazonPay", environment: '0', is_enabled: '0' })
...
//                                                                     onClick={(e) => setRazorPay({ ...razorPay, is_enabled: 1 })}
//                                                                 />
//                                                                 <span className="peer-checked:text-success">Enabled {razorPay.is_enabled == 1 ? "true" : "false"}</span>
//                                                             </label>
//                                                             <label className="inline-flex ml-3">
//                                                                 <input
//                                                                     id="statuss"
