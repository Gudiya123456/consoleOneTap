...
//     {
//         id: 1,
//         restaurant_name: 'Caroline',
//         lastName: 'Jensen',
//         no_of_branches: 'carolinejensen@zidant.com',
//         admin_phone: '2004-05-28',
//         address: {
...
//         lastName: 'Grant',
//         no_of_branches: 'celestegrant@polarax.com',
//         admin_phone: '1989-11-19',
//         address: {
...
//     {
//         id: 3,
//         restaurant_name: 'Tillman',
//         lastName: 'Forbes',
//         no_of_branches: 'tillmanforbes@manglo.com',
//         admin_phone: '2016-09-05',
//         address: {
...
//         isActive: false,
//         age: 2,
//         admin_email: 'APPLIDECK',
//     },
//     {
//         id: 4,
//         restaurant_name: 'Daisy',
//         lastName: 'Whitley',
//         no_of_branches: 'daisywhitley@applideck.com',
//         admin_phone: '1987-03-23',
//         address: {
...
//     {
//         id: 5,
//         restaurant_name: 'Weber',
//         lastName: 'Bowman',
//         no_of_branches: 'weberbowman@volax.com',
//         admin_phone: '1983-02-24',
//         address: {
...
//     const [initialRecords, setInitialRecords] = useState(sortBy(restList, 'restaurant_name'));
//     const [recordsData, setRecordsData] = useState(initialRecords);

//     const [search, setSearch] = useState('');
//     const [sortStatus, setSortStatus] = useState<DataTableSortStatus>({
//         columnAccessor: 'restaurant_name',
//         direction: 'asc',
//     });
...
//     useEffect(() => {
//         setInitialRecords(() => {
//             return restList.filter((item) => {
//                 return (
//                     item.restaurant_name.toLowerCase().includes(search.toLowerCase()) ||
//                     item.admin_email.toLowerCase().includes(search.toLowerCase()) ||
//                     item.admin_phone.toLowerCase().includes(search.toLowerCase()) ||
//                     item.no_of_branches.toLowerCase().includes(search.toLowerCase()) 
//                 );
//             });
//         });
...
//     const [initialRecords2, setInitialRecords2] = useState(sortBy(restList, 'restaurant_name'));
...
//                 return (
//                     item.restaurant_name.toLowerCase().includes(search2.toLowerCase()) ||
//                     item.admin_email.toLowerCase().includes(search2.toLowerCase()) ||
//                     item.admin_phone.toLowerCase().includes(search2.toLowerCase()) ||
//                     item.no_of_branches.toLowerCase().includes(search2.toLowerCase()) 
//                 );
//             });
//         });
//         // eslint-disable-next-line react-hooks/exhaustive-deps
...
//                             { accessor: 'admin_email', title: 'Admin Email', sortable: true },
...
"id": 1,
            "type": "MAIN",
            "branch_name": "Sulthan Bathery",
            "branch_email": "wilton.bathery@gmail.com",
            "branch_phone": "9874563251",
            ...
            "status": 0,
            "created_at": "2024-06-19T06:58:12.000000Z",
            "updated_at": "2024-06-19T12:06:08.000000Z"