        ...
        <div>
            ...
            <div className="panel  mt-6">
                <div className="flex flex-col md:flex-row md:items-center mb-5 gap-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">Branch Details</h5>
                                ...
                                columns={[
                                    {
                                        ...
                                        title: 'Branch Name',
                                        sortable: true,
                                        render: ({ branch_name, id }) => (
                                            <NavLink to='#' > <div className="flex items-center w-max">
                                                {/* <img className="w-9 h-9 rounded ltr:mr-2 rtl:ml-2 object-cover" src={`/assets/images/profile-${id}.jpeg`} alt="" /> */}
                                    ...
                                    { accessor: 'branch_email', title: 'Branch Email', sortable: true },
                                    { accessor: 'branch_phone', title: 'Branch Phone', sortable: true },
                                    { accessor: 'country', title: 'Address', sortable: true },

                                    {
                                        ...
                                        render: ({ status }) => <label className="w-12 h-6 relative">
                                            <input type="checkbox" value={status} className="custom_switch absolute w-full h-full opacity-0 z-10 cursor-pointer peer" id="custom_switch_checkbox1" />
