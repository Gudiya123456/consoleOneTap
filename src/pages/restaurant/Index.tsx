            ...
            <div className=" grid grid-cols-3  gap-5">
              {resList.map((restaurant: any) => (
                <div key={restaurant.id}>
                  ...
                  >
                    <div
                      className={` dark:bg-[#202125]  bg-[linear-gradient(to_bottom,rgba(0,0,0,0)53%,rgba(0,2,0.8)95%)] rounded-3xl h-[160px]  relative`}
                      style={{
                        height: "180px",
                        backgroundSize: "cover",
                        backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0)53%, rgba(0,2,0.8)95%), url(https://cdn.onetapdine.com${restaurant.background})`,
                      }}
                    >
                    ...
                    <form>
                      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-2 gap-x-5">
                        ...
                        <div className="mb-3">
                          ...
                          <select
                            className="input-form h-[33px] text-sm dark:border-[#5E5E5E] dark:bg-transparent"
                            name="country"
                          ...
                          >
                            ...
                            <option className="text-sm" value="INDIA">
                              INDIA
                            </option>
                            <option className="text-sm" value="USA">
                              USA
                            </option>
                            <option className="text-sm" value="UAE">
                              UAE
                            </option>
                          </select>
                          {errors?.country ? (
                            ...
                            <div className="mt-3">
                              <label className="inline-flex">
                                <input
                                  ...
                                  onChange={(e) => changeValue(e)}
                                  className="form-radio border-[#B3B3B3] text-success peer"
                                />
                                <span
                                  style={{ color: "#5E5E5E" }}
                                  className="peer-checked:text-success text-success text-style roboto-light"
                                >
                                  Live
                                </span>
                              </label>
                              <label className="inline-flex px-5">
                                ...
                                <span
                                  style={{ color: "#5E5E5E" }}
                                  className="peer-checked:text-secondary text-style roboto-light"
                                >
                                  Demo
                                </span>
                              </label>
