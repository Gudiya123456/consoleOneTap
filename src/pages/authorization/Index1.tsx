    ...
    <>
     ...
     <div className="panel flex justify-between items-center overflow-x-auto whitespace-nowrap p-1.5 rounded-none ">
               ...
               <div className="rounded-full p-1.5   ltr:mr-3 rtl:ml-3">
                ...
                <p style={{letterSpacing:'1px', fontFamily:'Poppins', fontSize:'0.85rem', fontWeight:'400', lineHeight:'25px' }} className='ltr:ml-3 text-blue-700' >Authorization</p>
          ...
          type="button" className="btn btn-sm btn-dark mr-5">Add Authorization</button>
           </div>
            </div>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <TableDrawer showDrawer={showDrawer} setShowDrawer={setShowDrawer} authList={authList} />

          <div className="flex md:items-center md:flex-row flex-col p-3 gap-5">
                  ...
                  <div className="min-w-max  md:min-w-full">
                    ...
                    {authList.map((data, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-center">
                        <label onClick={()=>{alert(999)}} className="w-12 h-6 relative">
