            ...
            <div className="">
                <div className="relative bg-[#F2F2F2] flex w-full items-center px-5 py-2.5 dark:bg-[#202125]">
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-white">
                        ...
                        <div className="sm:ltr:mr-auto sm:rtl:ml-auto">
                            <div style={{ width: '300px' }} className='bg-[#FFFFFF] gap-2 flex px-1 py-1.5 rounded-3xl' >

                                <IconSearch  className='mt-1 ml-1 text-black'  />
                                <div className='bg-[#EDEDED]'>
                                    <input style={{ fontFamily: 'Roboto', fontWeight: 500, fontStyle: 'normal' }} className='bg-[#FFFFFF] font-semibold text-[#9A9A9A] outline-0 ' type='text' placeholder='Search for restaurants' />
                                </div>
                            </div>
                        ...
                        <div>
                            <img className='w-7 h-7' src={themeConfig.theme == 'dark' ? doorbellWhite : doorbell} alt="" />
                        </div>
