...
const initialState = {
    ...
    customerToken: localStorage.getItem('customerToken') || themeConfig.customerToken,
    custOrderId: localStorage.getItem('custOrderId') || themeConfig.custOrderId,
    customerData: JSON.parse(localStorage.getItem('customerData') || '{}') || themeConfig.customerData || themeConfig.customerData,
    cartItems: JSON.parse(localStorage.getItem('cartItems') || '[]') || defaultState.cartItems || defaultState.cartItems,
...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        setCustOrderId(state, { payload }) {
            localStorage.setItem('custOrderId', payload);
            state.custOrderId = payload;
        },
...
export const { setCartItems, toggleTheme, setCustomerToken, setCustomerData, setCustOrderId, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleLocale, toggleSidebar, setPageTitle } = themeConfigSlice.actions;
